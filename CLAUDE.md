...
- Rendered SVGs are only regenerated when the cache file is missing. After changing the parser or renderer, clear `<sync_dir>/.rmsync/cache/*.svg` to see the effect.
